...
const modelDOM1 = new ClockModel(-5);
const viewDOM1 = new ClockViewDOM("clock1");
const controllerDom1 = new ClockController();


const containerElem1 = document.getElementById("clock1");



viewDOM1.init(modelDOM1);

modelDOM1.init(viewDOM1);

controllerDom1.init(modelDOM1, containerElem1);
